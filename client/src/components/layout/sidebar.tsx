  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { title: "Create Project", path: "/design-control/create" },
        { title: "Design Plan & User Requirements", path: "/design-control/design-plan" },
        { title: "Design Inputs", path: "/design-control/inputs" },
        { title: "Design Outputs", path: "/design-control/outputs" },
        { title: "Design Verification", path: "/design-control/verification" },
        { title: "Design Validation", path: "/design-control/validation" },
        { title: "Traceability Matrix", path: "/design-control/dynamic-traceability" },
        { title: "Design History File", path: "/design-control/history-file" },
      ],
    },
    {
