...
export class SharePointStorageProvider extends StorageProviderInterface {
  ...
  async testConnection(): Promise<ConnectionTestResult> {
    return {
      connected: false,
      error: "SharePoint provider not yet implemented",
      capabilities: {
        upload: false,
        download: false,
        delete: false,
  ...
  async validateConfig(): Promise<{ valid: boolean; errors: string[] }> {
    return {
      valid: false,
      errors: ["SharePoint provider not yet implemented"]
    };
  }
