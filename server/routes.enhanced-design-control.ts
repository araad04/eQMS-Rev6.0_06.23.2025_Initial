...
export function setupEnhancedDesignControlRoutes(app: Express) {
  ...
  app.get("/api/design-phase-actions/:projectId/:phaseId", authMiddleware.isAuthenticated, async (req, res) => {
    try {
          ...
          inputs: [
            {
              ...
              title: "Advanced Performance Requirements",
              description: "Component must meet high-reliability performance specifications for critical applications",
              ...
              acceptanceCriteria: "Component performance validated with 99.9% reliability per applicable standards",
              verificationMethod: "Test",
              priority: "critical",
              riskLevel: "High",
              status: "approved",
              traceabilityUpstream: ["Customer Spec CS-001", "Regulatory Standards"],
              fileUploads: [],
            ...
            },
            {
              ...
              description: "Component must withstand demanding environmental conditions per applicable standards",
      ...
      const phaseData = phaseActionData[phaseId as keyof typeof phaseActionData] || {};
